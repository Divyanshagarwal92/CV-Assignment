...
template_half_window_size = 6 ; % Half size of the template window
grid_MN = [40, 40];              % Number of rows and cols in the grid
...
tracking_params.rect = [197 63 35 127];
...
% tracking_params.rect = chooseTarget(data_params)
tracking_params.rect = [154 129 47 49];
...
%tracking_params.rect = chooseTarget(data_params)
tracking_params.rect = [313 223 35 111];
